    ...
    class Client
    {
        ...
        public void Save()
        {
            ...
            if(existingSaveData)
            {
                ...
                //Server.WriteSaveData();
                Console.WriteLine($"Existing save data found for player: {player.username}(ID:{loginID}) overwritten");
            }
            else
            {
                Server.saveData.Add(loginID, player);
                //Server.WriteSaveData();
                Console.WriteLine($"New save data created for player: {player.username} (ID:{loginID})");
            }
        }
    }
}
